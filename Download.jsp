...
<td><a href="staffdownloadjava.jsp?fname1=<%=rs.getString(3)%>&&fkeyl=<%=rs.getString(6)%>&&headkey=<%=file %>&&id=<%=rs.getString(1) %>"><button class="btn-btn-info btn-sm"> Download</button></a></td>
</tr>
<%}%>
            </table>
        </center>

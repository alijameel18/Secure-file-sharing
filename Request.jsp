...
<style>
body{
background-image: url('images/9f8be61ac437b051bef5a05792738cb8.png');
...
<%
		Random r1=new Random(); 
		 ...
		 %>
<body>
<button onclick="goBack()" class="btn btn-outline-danger" style="float:right;">Go Back</button><br><br>
<center>
...
<table class="table  table-hover table-dark">
 ...
 <td style="text-align: center;"><%=  rs.getString(6) %></td>
  <td style="text-align: center;"><%=t6 %></td> 
   ...
   <td><a href="RequestView.jsp?idtask=<%=rs.getString(1)%>&&tlkey=<%=t6%>"><button class="btn btn-primary" onclick="fun();">ACCEPT</button></a></BR><BR><a href="DELETE.jsp?idtask=<%=rs.getString(1)%>&&tlkey=<%=t6%>"><button class="btn btn-danger" onclick="fun();">DELETE</button></a></td>
       </tr> 
	<%} %>
